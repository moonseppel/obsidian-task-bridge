...
import { hasAnyEdit } from '../note-access/note-edits';
import { OrphanHousekeeping } from '../orphans/orphan-housekeeping';
import { NoteFailureReporter } from '../sync-run/note-failure-reporter';
import { OrphanTracker } from '../orphans/orphan-tracker';
import { ResolvedProject, resolveProject } from '../sync-run/project-resolver';
import { RemoteChildSync } from './remote-child-sync';
import { runThenCommit } from '../sync-run/run-then-commit';
import { SourceNote } from '../note-access/source-note';
import { SyncOutcome, emptyOutcome, mergeOutcomes } from '../sync-run/sync-outcome';
import {
  LineUnderSync,
  LinkedLine,
  NoteSnapshot,
