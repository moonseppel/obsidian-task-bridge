...
export interface SourceNote {
  ...
  applyEdits(edits: NoteEdits, indentation: Indentation): Promise<number>;
  /**
   ...
   */
  appendAnchorIfMissing(lineNumber: number, blockId: string, indentation: Indentation): Promise<boolean>;
}
