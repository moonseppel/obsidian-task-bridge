...
- [ ] Test for complex description 
	...
	This should also be part of the description. I pressed enter and then shift+ enter, to keep the indention. The description should not end on new lines, but on less (not more!) intendtion.

	This is not part of the description. I pressed enter three times, new line, removal of indention and then again for a new line.
This should not be part of the description anyway, because it is not indented.
